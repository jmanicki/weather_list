defmodule WeatherList.CityController do
  ...
  def index(conn, _params) do
    citylist = Repo.all(City)
    render(conn, "index.html", citylist: citylist)
  end
  ...
  def create(conn, %{"city" => city_params}) do
    ...
    HTTPoison.start
    HTTPoison.get!("http://api.openweathermap.org/data/2.5/weather?q=#{city_params["name"]}&APPID=31e63b93cf7a1466b1f437efe0622242 ")
    changeset ++ ["weather": HTTPoison.Response]
